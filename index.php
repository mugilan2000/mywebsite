...
<body>
            ...
            #myNavbar">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="navbar-nav">
						...
						<li class="nav-item">
                            <a href="login.php" class="nav-link" id="loginbtn">Login</a>
                        </li>
						<li class="nav-item">
                            <a href="registration.php" class="nav-link" id="registerbtn">Register</a>
                        </li>
                    </ul>
	...
	<br>
	<div class="container">
	<h3>Welcome to Murugan Vibes</h3>
	<br>
			...
			<div class="col-lg-4 mb-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="stories.php" target="_blank" class="btn btn-outline-primary btn-sm">
							Go to Stories
						</a>
