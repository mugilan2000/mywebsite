...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container py-4">
        ...
        <div class="table-responsive py-3">
            ...
            $query = "SELECT * from users order by create_datetime desc";
            $query_run = mysqli_query($con, $query);
            $totalusers = mysqli_num_rows($query_run);
            //$totalpages = ceil($totalusers / $num_per_page);
            ...
            $query_run = mysqli_query($con, $query);
            //echo $totalpages;
            echo "<p>Total No of Users - ".$totalusers;
            //echo "<p>Users from - ".($start_from+1)." To ".($start_from+$num_per_page)."</p>";
            ?>
            ...
            echo "<br>";
            if ($page > 1) {
                echo "<a href='users.php?page=" . ($page - 1) . "' class=''>Previous</a>";
            }
            ...
            if ($i > $page) {
                echo "<a href='users.php?page=" . ($page + 1) . "' class=''>Next</a>";
            }
            ?>
            <br>
